...
from evaluate_deep_autoencoder import (
    ERRORS_PATH,
    METRICS_JSON_PATH,
    THRESHOLD_PATH,
)
from train_final_deep_autoencoder import HISTORY_PATH


# paths
PROJECT_ROOT = Path(__file__).resolve().parents[1]
FIGURE_DIR = PROJECT_ROOT / "artifacts" / "figures" / "deep_autoencoder"
FIGURE_DPI = 220
...
def save_training_curve() -> None:
    ...
    plt.title("Deep Autoencoder Training Curve")
    plt.legend()
    plt.tight_layout()
