"""
Evaluate the deep autoencoder anomaly detector.
"""
...
METRICS_CSV_PATH = EVALUATION_DIR / "deep_metrics.csv"
METRICS_JSON_PATH = EVALUATION_DIR / "deep_metrics.json"
ERRORS_PATH = EVALUATION_DIR / "deep_reconstruction_errors.npz"
